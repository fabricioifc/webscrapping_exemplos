...
class Captura:
    ...
    '''
    nav = webdriver.Firefox(executable_path='/home/fabricio/Desktop/webscrapping/geckodriver')
    ...
    def inicio(self):
        ...
        tabela = pagina.find('table' , attrs={'class': 'tabela-expandir' })
...
class parserTabelaIPCA:
    ...
    def analisaTabela(self, tabela):
        ...
        if len(column_names) > 0 and len(column_names) != nColunas:
            print('[e] Quantidade de colunas difere da quantidade de titulos de colunas capturados!')
